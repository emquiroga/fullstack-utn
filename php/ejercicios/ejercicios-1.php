...
function esPar($val) {
    if (($val % 2) == 0){
      echo "Tu número es PAR";
    } else{
        echo "Tu número es IMPAR";
    }
}
...
// 4) Dados 10 valores numéricos en variables separadas, informar cual
...
//TEST
// echo showHighest($arrOfVal);
//---------//

// 5) Utilizando el concepto de ARRAY, dados 50 números enteros,
...
// 6) Dado un valor numérico X, imprimir los X primeros múltiplos de 3
...
// 7) Define las variables $tipo, $grosor, $diametro y $marca. Establece
